...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname Universe-Experiment-1b--Server) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
;#lang racket
